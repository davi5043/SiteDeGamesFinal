    ...
    <header class="site-header">
        <div class="header-inner">
            ...
            <nav class="header-nav">
                ...
                if ($foto_usuario): ?>
                    <img src="<?= BASE_URL ?>uploads/<?= escape($foto_usuario) ?>" class="avatar" alt="Avatar">
                <?php else: ?>
                    <div class="avatar-fallback"><?= get_avatar_initials(get_usuario_nome()) ?></div>
                <?php endif; ?>

                <span class="nome"><?= escape(get_usuario_nome()) ?></span>
                <a href="<?= BASE_URL ?>pages/usuario/editar_usuario.php" class="btn-sair" style="color:#7c3aed;">Minha Conta</a>
    ...
    <main class="dashboard-container">
        ...
        <?php if (empty($minhas_noticias)): ?>
            <div class="empty-state">
                ...
                <a href="<?= BASE_URL ?>pages/noticias/nova_noticia.php" class="empty-state-link">Publicar minha primeira notícia →</a>
            </div>
        <?php else: ?>
                ...
                <table class="tabela">
                    ...
                    <tbody>
                        <?php foreach ($minhas_noticias as $noticia): ?>
                            <tr>
                                <td>
                                    <a href="<?= BASE_URL ?>pages/noticias/noticia.php?id=<?= $noticia['id'] ?>" class="tabela-titulo-link">
                                ...
                                <td class="tabela-acoes">
                                    <a href="<?= BASE_URL ?>pages/noticias/editar_noticia.php?id=<?= $noticia['id'] ?>" class="btn-editar">
                                        Editar
                                    </a>
