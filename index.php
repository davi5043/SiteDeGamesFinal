...
// Divide as notícias: destaque (1), laterais (3), lista (restante)
$destaque    = $noticias[0] ?? null;
$secundarias = array_slice($noticias, 1, 3);
$lista       = array_slice($noticias, 4);
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        [data-theme="dark"] .card-sec:hover {
            border-color: #1c1831;
        }
        ...
        .card-sec:hover .card-sec-img img {
        ...
        [data-theme="dark"] .card-sec:hover h3 {
            color: #a78bfa;
        }
